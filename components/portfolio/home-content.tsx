...
export default function HomeContent() {
  ...
  const h = t.home;
  const resumePath = lang === 'zh' ? '/resume' : '/en/resume';
  return (
    <div className="site">
      ...
      <main className="workspace">
        ...
        <section id="projects" className="section-block">
          <SectionTitle num="04" title={h.projects.title} en="SELECTED WORK" />
          {h.cases.items.length > 0 && (
            <>
              <div className="case-label mono">{h.cases.label}</div>
              <div className="case-grid">
                {h.cases.items.map((item, i) => (
                  <Dialog key={item.title}>
                    <DialogTrigger className="project-card case-card">
                      <div className="project-top">
                        <span className="mono">CASE / 0{i + 1}</span>
                      ...
                      <div className="project-content">
                        ...
                        <div className="project-bottom">
                          <span className="mono">{h.cases.result}</span>
                          <span>
                    ...
                    <DialogContent className="project-dialog case-dialog">
                      <span className="mono">CASE / 0{i + 1}</span>
                      <DialogTitle>{item.title}</DialogTitle>
                      <DialogDescription>{item.summary}</DialogDescription>
                      <div className="case-field">
                        <span className="mono">{h.cases.background}</span>
                        <p>{item.background}</p>
                      </div>
                      <div className="case-field">
                        <span className="mono">{h.cases.problem}</span>
                        <p>{item.problem}</p>
                      </div>
                      <div className="case-field">
                        <span className="mono">{h.cases.action}</span>
                        <p>{item.action}</p>
                      </div>
                      <div className="case-field">
                        <span className="mono">{h.cases.result}</span>
